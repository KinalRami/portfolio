...
export default function Skills() {
  ...
  return (
    <section id="skills" className="bg-white dark:bg-zinc-900 text-zinc-800 dark:text-zinc-100 py-20">
      <div className="max-w-6xl mx-auto">
        <p className="text-sky-500 text-sm uppercase mb-2">Skills</p>
            ...
            <div className="flex flex-wrap gap-5">
              {skills.map((skill, idx) => (
                <motion.div
                  ...
                  className="relative group bg-zinc-800 rounded-xl shadow-md hover:shadow-sky-600/30 hover:scale-105 transition-all p-4 w-[70px] h-[70px] flex items-center justify-center"
                  title={skill.name}
                  >
                  <Image
                    src={skill.icon}
