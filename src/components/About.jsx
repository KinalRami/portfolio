    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-zinc-500 dark:text-zinc-400 leading-relaxed">
          I’m <span className="dark:text-white font-medium">Kinal Rami</span>, a passionate frontend developer with strong expertise in{' '}
          <span className="dark:text-white">Vue.js, Nuxt.js, and Tailwind CSS</span>, along with experience working in{' '}
          <span className="dark:text-white">React.js and Shopify design</span>. I specialize in building elegant, scalable UIs and turning ideas into
        ...
        <p className="mt-6 text-zinc-500 dark:text-zinc-400 leading-relaxed">
          ...
          <span className="dark:text-white font-medium">freelance and remote opportunities</span> where I can contribute, collaborate, and grow.
        </p>
      </div>
