...
import { ArrowDown, Github, Linkedin, Dribbble, Twitter, } from 'lucide-react';
    ...
    <section className="relative min-h-screen flex items-center justify-center text-white overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <motion.p
          ...
          className="text-3xl sm:text-4xl font-bold mt-4 text-gray-200 h-12"
          >
          {/* className="text-xl mt-4 text-gray-200 h-8" */}
          <Typewriter
            words={[
              'Frontend Developer',
              'Vue & Nuxt Specialist',
        ...
        <p className="mt-4 text-base sm:text-md text-gray-300 max-w-xl mx-auto leading-relaxed">
      ...
      <Link
        href="#about"
        className="absolute bottom-1 w-10 left-[calc(50%-10px)] transform -translate-x-1/2 z-20 flex flex-col items-center group animate-bounce"
      >
        <span className="text-xs [writing-mode:vertical-rl] text-gray-300 group-hover:text-white uppercase tracking-widest">
          Scroll Down
        </span>
